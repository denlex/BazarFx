...
public class CharacteristicCatalogView implements FxmlView<CharacteristicCatalogViewModel> {
    ...
    public void addTypeButtonClicked(Event event) {
        ViewTuple<CharacteristicTypeEditView, CharacteristicTypeEditViewModel> viewTuple = FluentViewLoader.fxmlView(CharacteristicTypeEditView.class).load();
    ...
    public void addCharacteristicButtonClicked(Event event) {
        ViewTuple<CharacteristicEditView, CharacteristicEditViewModel> viewTuple = FluentViewLoader.fxmlView(CharacteristicEditView.class).load();
        viewTuple.getViewModel().setParentViewModel(viewModel);
        Parent root = viewTuple.getView();
