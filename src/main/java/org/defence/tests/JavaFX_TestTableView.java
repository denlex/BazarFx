...
import org.defence.control.ButtonCell;
...
public class JavaFX_TestTableView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Callback<TableColumn, ButtonCell> buttonCellFactory =
                new Callback<TableColumn, ButtonCell>() {
                    @Override
        ...
        TableColumn colButton = new TableColumn("Menu");
                new PropertyValueFactory<Record,ButtonCell>("Menu");
        colButton.setCellFactory(buttonCellFactory);

        tableView.setItems(recordList);
        tableView.getColumns().addAll(colId, colName, colLastName, colEmail, colButton);
