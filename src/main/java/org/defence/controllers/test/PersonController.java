...
public class PersonController implements Initializable {
    ...
    @FXML
    private ListView personsViewList;
    ...
    private void personsViewListRegisterEvents() {


        // Define rendering of the list of values in ComboBox drop down.
        personsViewList.setCellFactory((listView) -> new ListCell<Person>() {
            @Override
        ...
        /*personsViewList.setConverter(new StringConverter<MeasurementType>() {
            @Override
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        personsViewList.setItems(persons);
        personsViewListRegisterEvents();
